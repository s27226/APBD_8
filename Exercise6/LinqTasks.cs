...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job.Equals("Frontend programmer") && e.Salary > 1000).OrderByDescending(e => e.Ename);
            return result;
        }
        ...
        {
            Emp result = Emps.OrderByDescending(e => e.HireDate).Where(e => e.Job.Equals("Frontend programmer")).First();
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.GroupBy(e => e.Deptno).Join(Depts, e => e.Key, d => d.Deptno, (e,d) => new {
                name = d.Dname,
        ...
        {
            IEnumerable<Emp> result = Emps.FindWithSubordinate();
            return result;
        }
        ...
        {
            //IEnumerable<Dept> result = Emps.GroupBy(e => e.Deptno).Where(e => e.Count() == 5).Join(Depts, e => e.Key, d => d.Deptno, (d,f) => f).OrderBy(d => d.Dname);
            IEnumerable<Dept> result = Depts.GroupJoin(Emps, d => d.Deptno, e => e.Deptno, (d,e) => new {
                d,
                num = e.Count()
            }).Where(e => e.num == 0 || e.num == 5).Select(e => e.d);
    ...
    {
        public static IEnumerable<Emp> FindWithSubordinate(this IEnumerable<Emp> col)
        {
            return col.Where(e => col.Any(f => f.Mgr == e)).OrderByDescending(e => e.Salary).OrderBy(e => e.Ename);
        }
    }
}